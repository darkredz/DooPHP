...
$config['BASE_PATH'] = str_replace('demos\template_engine', 'dooframework', str_replace('demos/template_engine', 'dooframework', $config['SITE_PATH']));
...
$config['SUBFOLDER'] = '/demos/template_engine/';
